...
const PublicNavbar = () => {
    ...
    async function ReadCat() {
        let url = "http://localhost:5000/home-page-category";
    ...
    return (
        <div className="header section">
            <PublicTopHeader loggedIn={loggedIn} setLoggedIn={setLoggedIn}/>
                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-xl-8 d-none d-xl-block">
                                <div className="main-menu position-relative">
                                    <ul>
                                        ...
                                        {cat.map(cat => (
                                            <li key={cat.id} className="has-children">
                                                <Link to="#"><span>{cat.CategoryName}</span> <i
                                                    className="fa fa-angle-down"></i></Link>
                                                <ul className="sub-menu">
                                                    {cat?.subCategory?.map(subCat => (
                                                        <li key={subCat.id}>
                                                            <Link to="/products"
                                                                  state={{id: subCat.id}}>{subCat.sub_cat}</Link>
                                                        </li>
                                                    ))}
                                                </ul>
                                            </li>
                                        ...
                                        {/*{loggedIn && <li className="has-children">*/}
                                        {/*    <Link to="#">*/}
                                        {/*        <span>Settings</span>*/}
                                        ...
                                        {/*        <li><Link to="/user/logout" onClick={UserLogout}>Logout</Link></li>*/}
                                        {/*    </ul>*/}
                                        {/*</li>}*/}
                                    </ul>
                                </div>
                            ...
                            <div className="col-xl-2 col-6">
                                <div className="header-actions">
                                    ...
                                    {/*<Link to="/search" className="header-action-btn header-action-btn-search">*/}
                ...
                <div className="cart-offcanvas-inner">
                    ...
                    <div className="offcanvas-cart-content">
                        ...
                        <div className="cart-product-wrapper mb-6">
                            ...
                            <div className="single-cart-product">
                                <div className="cart-product-thumb">
                                    <Link to="single-product.html"><img src="assets/images/products/small-product/1.jpg"
                                                                        alt="Cart Product"/></Link>
                                </div>
                                <div className="cart-product-content">
                                    <h3 className="title"><Link to="single-product.html">Brother Hoddies in Grey</Link>
                                    </h3>
                        ...
                        <div className="cart-product-wrapper mb-6">
                            ...
                            <div className="single-cart-product">
                                <div className="cart-product-thumb">
                                    <Link to="single-product.html"><img src="assets/images/products/small-product/2.jpg"
                                                                        alt="Cart Product"/></Link>
                                </div>
                                <div className="cart-product-content">
                            ...
                            <div className="single-cart-product">
                                <div className="cart-product-thumb">
                                    <Link to="single-product.html"><img
                                        src="assets/images/products/small-product/3.html" alt="Cart Product"/></Link>
                                </div>
                                <div className="cart-product-content">
                                    <h3 className="title"><Link to="single-product.html">Enjoy The Rest T-Shirt</Link>
                                    </h3>
                                    <span className="price">
